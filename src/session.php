...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="container" id="form">
        <form action="back/try-login.php" method="POST">
            ...
            <div class="flex-column">
                <button type="submit" class="btn btn-dark" id="submit-btn">Entrar</button><br>
        </form>
        <a href="#"><button class="btn btn-dark" id="register-btn">Cadastre-se</button></a>
    </div>
    </div>
